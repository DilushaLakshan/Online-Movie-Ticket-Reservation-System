                ...
                <div class="offcanvas offcanvas-start ms-3 mt-3 mb-3 text-light" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" style="border-radius: 15px;background-color: #000F45">
                    ...
                    <div class="offcanvas-body">
                        ...
                        <div class="col-12 mt-2">
                            <a href="managerHome.php" class="btn btn-outline-warning text-decoration-none w-100 text-light fs-5" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">HOME</a>
                        </div>
                        <div class="col-12 mt-2">
                            <a href="allMoviesManager.php" class="btn btn-outline-warning text-decoration-none w-100 text-light fs-5" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">VIEW ALL MOVIES</a>
                        </div>
                        <div class="col-12 mt-2">
                            <a href="viewBookingHistory.php" class="btn btn-outline-warning text-decoration-none w-100 text-light fs-5" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">BOOKING HISTORY</a>
                        </div>
                        <div class="col-12 mt-2">
                            <a href="inquiryView.php" class="btn btn-outline-warning text-decoration-none w-100 text-light fs-5" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">INQUIRIES</a>
                        </div>
                        <div class="col-12 mt-2">
