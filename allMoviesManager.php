...
<head>
    ...
    <title>All Movies - Manager View</title>
                                    ...
                                    <div class="col-12 col-md-4 col-lg-3 p-3">
                                        <div class="card border-0 allMov">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <button class="btn btn-outline-warning w-100" style="font-size: smaller;" onclick="window.location='movieDetailsManager.php?movieID=<?php echo $movieData['id']; ?>';">VIEW DETAILS</button>
                                            </div>
                                        </div>
                                    </div>
                            <?php
