        ...
        <div class="row">
            ...
            <div class="col-12 mt-2">
                <div class="row justify-content-center">
                    ...
                    ?>
                            <div class="col-12 ms-3 me-3" style="background-color: rgb(255, 196, 1);border-radius: 5px;">
                                <h4 style="color: #000F45;"><?php echo $categoryData["name"]; ?></h4>
                            </div>
                            <?php
                            ...
                            ?>
                                    ...
                                    <div class="col-12 col-md-4 col-lg-3 p-3">
                                        <div class="card border-0 allMov">
                                            ...
                                            <div class="card-body">
                                                <h4 style="color: #EAE1E5;"><?php echo $movieData["title"]; ?></h4>
                                                <button class="btn btn-outline-warning w-100" style="font-size: smaller;" onclick="window.location='movieDetails.php?movieID=<?php echo $movieData['id']; ?>';">WATCH TRAILOR</button>
                                            </div>
                                        </div>
                                    </div>
                            <?php
